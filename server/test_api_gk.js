...
async function testApi() {
    ...
    // Simulate what the UI endpoint gets exactly for GK_SMART_AI year 2025
    ...
    let allJournals = await mongoose.connection.collection('journalentries').find({ companyCode: 'GK_SMART_AI' }).toArray();
    ...
    console.log("=== ASSETS BALANCES FOR GK_SMART_AI ===");
    let eqKeys = Object.keys(bsData).filter(k => k.startsWith('1'));
    eqKeys.forEach(k => {
