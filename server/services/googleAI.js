...
Extract all data into this exact JSON structure:
{
  ...
  "taxRegistrationDateKh": "Date in Khmer format (e.g. 釤⑨煛 釣樶焷釣熱灦 釤⑨煚釤⑨煡)",
...
Extract all data into this exact JSON structure:
{
  "entityNameKh": "Enterprise's name in Khmer as exactly written",
  "entityNameEn": "Enterprise's name in English",
  "registrationNumberKh": "Registration Number in Khmer Numerals (e.g. 釤♂煚釤犪煚釤め煡釤メ煛釤┽煛)",
  "registrationNumberEn": "Registration Number in Arabic Numerals (e.g. 1000455191)",
  "incorporationDateKh": "Date in Khmer format (e.g. 釤ａ煚 釣樶瀫釣氠灦 釤⑨煚釤⑨煡)",
  "incorporationDateEn": "Date in English format (e.g. 30 January 2025)",
  "legalFormKh": "Legal Form in Khmer (e.g. 釣�釤掅灇釣会灅釣犪煀釣会灀釣瀫釣囜灀釣戓瀾釣结灈釣佱灮釣熱瀼釤掅灇釣坚灉釣樶灦釣撫瀫釣樶煉釣氠灧釣?",
  "legalFormEn": "Legal Form in English (e.g. Private Limited Company)",
  "mocDocumentNo": "The document identifier at the top left (e.g. MOC-00044916 釣栣瀻.釣呩灁釣?",
  "issuedPlaceAndDateKh": "The place and date issued at the bottom right in Khmer (e.g. 釣氠灦釣囜瀿釣夺灀釣羔灄釤掅灀釤嗎灃釤佱瀴, 釤ａ煚 釣樶瀫釣氠灦 釤⑨煚釤⑨煡)",
...
Extract exhaustive details into this exact JSON structure:
{
  ...
  "shareholders": [{"nameEn": "Shareholder Name English", "nameKh": "Khmer if visible", "address": "Their Postal Registered Office Address 鈥?look under each Individual Shareholder section", "numberOfShares": 600, "nationality": "Foreigner or Cambodian"}],
  "registeredShareCapitalKHR": "The KHR value e.g. 80000000 鈥?look for Registered Share Capital (KHR)",
...
Extract exhaustive details into this exact JSON structure. Preserve Khmer Unicode text exactly as written:
{
  ...
  "directorsKh": [{"nameKh": "Director Name in Khmer (or null)", "addressKh": "Director Postal Registered Office Address 鈥?copy exactly as written even if Latin script", "titleKh": "Title in Khmer", "isChairman": false}],
  "shareholdersKh": [{"nameKh": "Shareholder Name in Khmer (or null)", "addressKh": "Shareholder Postal Registered Office Address 鈥?look under each Individual Shareholder section, copy exactly as written even if Latin script", "shares": "Number of shares", "nationality": "Foreigner or Cambodian"}],
...
Return ONLY a strict JSON object 鈥?no markdown, no code fences, no explanation.
...
IMPORTANT:
- Extract ALL directors listed 鈥?do not stop at one.
...
- For "descriptionKh": ONLY return actual Khmer Unicode script (釣�-釣?character range). NEVER return phrases like "Khmer script not available", "not available", "transliterated from English", or any English text in this field. If there is no actual Khmer text for the business activity, return null.
    ...
    try {
        ...
        const prompt = `
            ...
            **CONVERSATIONAL RULES & TASKS**:
            ...
            12. **Live Sync Architecture**: If the user asks to "Update FS7" (or any FS/TB form), or asks what happens when a GL code changes, you MUST explain clearly: "Whenever the General Ledger (GL1) is updated鈥攅ven a single transaction code鈥攖he entire form set (TB1-TB3, FS1-FS7) automatically triggers and updates in real-time. The system instantly checks the account code and date of the GL entry, sums it up, and lands it on the correct topic and month. I do not need to manually check or compile this; the whole system is live-linked and updates simultaneously." You can then trigger the 'refresh_reports' tool to force a UI sync for them.
            ...
            **馃敶 PHYSICAL BANK STATEMENT AUDIT MEMORY (BA's Source of Truth 鈥?Do NOT Ignore):**
