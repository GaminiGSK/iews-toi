...
// Find the AUDIT SKILL section and replace from its start to the blank lines after it
const startMarker = '            **AUDIT SKILL';
const endMarker = '\n\n\n\n';  // 4 newlines follow the section

const startIdx = content.indexOf(startMarker);
if (startIdx === -1) { console.error('Start marker not found'); process.exit(1); }

// Find the end: look for the double blank line after the audit section
...
console.log('\nDone. New section written successfully.');
