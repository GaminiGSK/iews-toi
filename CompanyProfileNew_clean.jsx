...
export default function CompanyProfile() {
    ...
    const handleExtractToProfile = async () => {
        ...
        // The system now recognizes the specific anchor text "NAME" and "釣撫灦釣樶瀫釣氠瀻釤? 
        ...
        if (isExtract) {
            ...
            extractedData = {
                ...
                "Location [KH]": "釣氠灦釣囜瀿釣夺灀釣羔灄釤掅灀釤嗎灃釤佱瀴",
            ...
            extractedData = {
                ...
                "Inc. Date [KH]": "釤♂煟 釣樶焷釣熱灦 釤⑨煚釤⑨煛",
                "Inc. Date [EN]": "13 April 2021",
                "Legal Form [KH]": "釣熱灎釣傖煉釣氠灦釣熱灟釣€釣斸灮釣傖煉釣傖灈",
            ...
            <div className="flex-1">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full">
                    ...
                    <div className="flex flex-col gap-6">
                        ...
                        {/* AGENTIC FILING CARD 鈥?4th Module */}
    ...
    const handleSendWorkspaceChat = async (overridingPrompt = null) => {
        ...
        try {
            ...
            setWorkspaceChat(prev => [...prev, { role: 'assistant', text: "鈿狅笍 Agent connection unstable. Please verify link to drive." }]);
        } finally {
                                ...
                                <div className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-500">
                                    <div className="flex justify-between items-start">
                                        <div>
                                            ...
                                            <p className="text-[10px] text-slate-500 font-bold uppercase tracking-widest">Source Entity Document 鈥?{activeDoc?.status}</p>
                                        </div>
                                        ...
                                        <div className="flex-1 overflow-y-auto mb-10 space-y-12 custom-scrollbar pr-4">
                                            {workspaceChat.length === 0 ? (
                                                <div className="h-full flex flex-col items-center justify-center opacity-10">
                                                    ...
                                                    <p className="text-xl font-black uppercase tracking-[0.5em]">Agent Synced 鈥?Awaiting Command</p>
                                                </div>
                                            ) : (
    ...
    // ==========================================
    // 馃敀 PROTECTED CORE LOGIC - DO NOT MODIFY
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-6">
                    <div className="bg-white rounded-xl shadow-2xl p-6 max-w-2xl w-full border-2 border-red-500 relative">
                        ...
                        <h3 className="text-xl font-bold text-red-600 mb-2 flex items-center">
                            <span className="bg-red-100 p-2 rounded-full mr-3">鈿狅笍</span>
                            {debugLog.title}
                        </h3>
