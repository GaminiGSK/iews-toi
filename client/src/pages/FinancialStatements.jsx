                ...
                <div className="bg-white rounded-b-xl rounded-tr-xl shadow-xl border border-gray-200 p-10 min-h-[600px] font-sans relative overflow-auto select-text print:shadow-none print:border-none print:rounded-none print:max-w-none print:w-full">
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full text-sm border-collapse">
                            ...
                            {/* --- STATEMENT OF CHANGES IN EQUITY (CIFRS) --- */}
                            ...
                            {/* --- NOTES TO THE FINANCIAL STATEMENTS (CIFRS) --- */}
                                    ...
                                    <tr>
                                        <td colSpan="2" className="p-6">
                                            ...
                                            <p className="text-gray-700 leading-relaxed mb-6">
                                                These financial statements have been prepared in accordance with the Cambodian International Financial Reporting Standards (CIFRS) and CIFRS for SMEs, as directed by the Accounting and Auditing Regulator (ACAR).
                                            ...
                                            <div className="space-y-4 text-gray-700">
                                                <p>
                                                    <strong>Revenue Recognition:</strong> Revenue from technology consulting and factory projects is recognized when control of goods or services is transferred to the customer across specified project milestones.
                                                </p>
                                                <p>
                                                    <strong>Property, Plant, and Equipment:</strong> PPE is stated at cost less accumulated depreciation. Depreciation for technology equipment (e.g., Computers) and fleet vehicles (e.g., Automobiles) is calculated on a straight-line basis using rates strictly adhering to GDT tax depreciation schedules.
                                                </p>
                                                <p>
                                                    <strong>Foreign Currencies:</strong> The functional and presentation currency is the Cambodian Riel (KHR) as per ACAR legal requirements. Transactions in foreign currencies are translated into the functional currency using the exchange rates prevailing at the dates of the transactions.
                                                </p>
                                            </div>

                                            <h4 className="font-bold text-gray-900 border-b pb-2 mb-4 mt-8">3. CRITICAL ACCOUNTING ESTIMATES AND JUDGEMENTS</h4>
                                            <p className="text-gray-700 leading-relaxed">
                                                The preparation of financial statements requires the use of certain critical accounting estimates. It also requires management to exercise its judgement in the process of applying the entity's accounting policies. Related Party Transactions or special itemized expenses are explicitly reconciled with physical bank statements and invoices.
                                            </p>
                                        </td>
                                    </tr>
                                </tbody>
