                    ...
                    <tbody className="divide-y divide-white/5">
                        {rows.map((e,i) => (
                            <tr key={i} className="group hover:bg-white/5">
                                ...
                                <td className="px-2 py-2"><input type="number" value={e.count} onChange={ev => updEmp(rows,setRows,i,'count',ev.target.value)} placeholder="0" className="w-16 bg-slate-700 border border-slate-600 rounded px-2 py-1 text-white outline-none focus:border-blue-400 text-xs text-center" /></td>
                                <td className="px-2 py-2"><input type="number" value={e.annualSalary} onChange={ev => updEmp(rows,setRows,i,'annualSalary',ev.target.value)} placeholder="0.00" className="w-28 bg-slate-700 border border-slate-600 rounded px-2 py-1 text-white outline-none focus:border-blue-400 text-xs text-right" /></td>
                                <td className="px-2 py-2"><input type="number" value={e.fringeBenefits} onChange={ev => updEmp(rows,setRows,i,'fringeBenefits',ev.target.value)} placeholder="0.00" className="w-28 bg-slate-700 border border-slate-600 rounded px-2 py-1 text-white outline-none focus:border-blue-400 text-xs text-right" /></td>
                                    ...
                                    {monthlyTOS.map((m,i) => {
                                        ...
                                        return (
                                            <tr key={i} className="hover:bg-white/5 transition">
                                                ...
                                                <td className="px-3 py-2"><input type="number" value={m.grossSalary} onChange={e => updMonth(i,'grossSalary',e.target.value)} placeholder="0.00" className="w-28 bg-slate-700 border border-slate-600 rounded px-2 py-1 text-white outline-none focus:border-blue-400 text-xs text-right" /></td>
                                                <td className="px-3 py-2"><input type="number" value={m.tosFiled} onChange={e => updMonth(i,'tosFiled',e.target.value)} placeholder="0.00" className="w-28 bg-slate-700 border border-slate-600 rounded px-2 py-1 text-white outline-none focus:border-blue-400 text-xs text-right" /></td>
                                                <td className="px-3 py-2"><input type="number" value={m.tosPaid} onChange={e => updMonth(i,'tosPaid',e.target.value)} placeholder="0.00" className="w-28 bg-slate-700 border border-slate-600 rounded px-2 py-1 text-white outline-none focus:border-blue-400 text-xs text-right" /></td>
