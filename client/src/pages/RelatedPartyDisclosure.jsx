...
const NI_BASE = 'bg-slate-700 border border-slate-600 rounded px-2 py-1 text-white outline-none focus:border-purple-400 text-xs';

function loanClosing(l) {
...
// YN moved outside to prevent focus-loss bug
                            ...
                            <tbody className="divide-y divide-white/5">
                                {parties.map((p, i) => (
                                    <tr key={i} className="group hover:bg-white/5">
                                        ...
                                        <td className="px-2 py-2"><NumericInput value={p.ownershipPct} onChange={v => updRow(setParties,i,'ownershipPct',v)} placeholder="%" className={`w-16 text-center ${NI_BASE}`}/></td>
                                ...
                                <tbody className="divide-y divide-white/5">
                                    {transactions.map((t, i) => (
                                        <tr key={i} className="group hover:bg-white/5">
                                            ...
                                            <td className="px-2 py-2"><NumericInput value={t.amount} onChange={v => updRow(setTransactions,i,'amount',v)} placeholder="0.00" className={`w-28 text-right ${NI_BASE}`}/></td>
                                            ...
                                            <td className="px-2 py-2"><select value={t.armLength} onChange={e => updRow(setTransactions,i,'armLength',e.target.value)} className="bg-slate-700 border border-slate-600 rounded px-2 py-1 text-white outline-none focus:border-purple-400 text-xs"><option value="yes">✅ Yes</option><option value="no">❌ No</option></select></td>
                                ...
                                <tbody className="divide-y divide-white/5">
                                    {directorLoans.map((l, i) => (
                                        <tr key={i} className="group hover:bg-white/5">
                                            ...
                                            <td className="px-2 py-2"><input value={l.partyName} onChange={e => updRow(setDirectorLoans,i,'partyName',e.target.value)} placeholder="Name" className="w-36 bg-slate-700 border border-slate-600 rounded px-2 py-1 text-white outline-none focus:border-purple-400 text-xs"/></td>
                                            <td className="px-2 py-2"><NumericInput value={l.openingBal}  onChange={v => updRow(setDirectorLoans,i,'openingBal',v)}  placeholder="0.00" className={`w-24 text-right ${NI_BASE}`}/></td>
                                            <td className="px-2 py-2"><NumericInput value={l.newLoans}    onChange={v => updRow(setDirectorLoans,i,'newLoans',v)}    placeholder="0.00" className={`w-24 text-right ${NI_BASE}`}/></td>
                                            <td className="px-2 py-2"><NumericInput value={l.repayments}  onChange={v => updRow(setDirectorLoans,i,'repayments',v)}  placeholder="0.00" className={`w-24 text-right ${NI_BASE}`}/></td>
                                            <td className="px-2 py-2 text-right font-black text-purple-300">{fmtN(loanClosing(l))}</td>
                                            <td className="px-2 py-2"><NumericInput value={l.interestRate} onChange={v => updRow(setDirectorLoans,i,'interestRate',v)} placeholder="%" className={`w-16 text-center ${NI_BASE}`}/></td>
                                            <td className="px-2 py-2"><NumericInput value={l.interestAmt}  onChange={v => updRow(setDirectorLoans,i,'interestAmt',v)}  placeholder="0.00" className={`w-20 text-right ${NI_BASE}`}/></td>
                                ...
                                <tbody className="divide-y divide-white/5">
                                    {dividends.map((d, i) => (
                                        <tr key={i} className="group hover:bg-white/5">
                                            ...
                                            <td className="px-2 py-2"><NumericInput value={d.pct}    onChange={v => updRow(setDividends,i,'pct',v)}    placeholder="%" className={`w-16 text-center ${NI_BASE}`}/></td>
                                            <td className="px-2 py-2"><NumericInput value={d.amount} onChange={v => updRow(setDividends,i,'amount',v)} placeholder="0.00" className={`w-32 text-right ${NI_BASE}`}/></td>
