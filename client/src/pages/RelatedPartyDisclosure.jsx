                            ...
                            <tbody className="divide-y divide-white/5">
                                {parties.map((p,i) => (
                                    <tr key={i} className="group hover:bg-white/5">
                                        ...
                                        <td className="px-2 py-2"><input type="text" inputMode="decimal" value={p.ownershipPct} onChange={e=>updRow(setParties,i,'ownershipPct',e.target.value)} placeholder="%" className="w-16 bg-slate-700 border border-slate-600 rounded px-2 py-1 text-white outline-none focus:border-purple-400 text-xs text-center"/></td>
                                ...
                                <tbody className="divide-y divide-white/5">
                                    {transactions.map((t,i) => (
                                        <tr key={i} className="group hover:bg-white/5">
                                            ...
                                            <td className="px-2 py-2"><input type="text" inputMode="decimal" value={t.amount} onChange={e=>updRow(setTransactions,i,'amount',e.target.value)} placeholder="0.00" className="w-24 bg-slate-700 border border-slate-600 rounded px-2 py-1 text-white outline-none focus:border-purple-400 text-xs text-right"/></td>
                                    ...
                                    {directorLoans.map((l,i) => (
                                        <tr key={i} className="group hover:bg-white/5">
                                            ...
                                            {['openingBal','newLoans','repayments'].map(f => (
                                                <td key={f} className="px-2 py-2"><input type="text" inputMode="decimal" value={l[f]} onChange={e=>updRow(setDirectorLoans,i,f,e.target.value)} placeholder="0.00" className="w-24 bg-slate-700 border border-slate-600 rounded px-2 py-1 text-white outline-none focus:border-purple-400 text-xs text-right"/></td>
                                            ))}
                                            <td className="px-2 py-2 text-right font-black text-purple-300">{fmtN(loanClosing(l))}</td>
                                            {['interestRate','interestAmt'].map(f => (
                                                <td key={f} className="px-2 py-2"><input type="text" inputMode="decimal" value={l[f]} onChange={e=>updRow(setDirectorLoans,i,f,e.target.value)} placeholder={f==='interestRate'?'%':'0.00'} className="w-20 bg-slate-700 border border-slate-600 rounded px-2 py-1 text-white outline-none focus:border-purple-400 text-xs text-right"/></td>
                                            ))}
                                ...
                                <tbody className="divide-y divide-white/5">
                                    {dividends.map((d,i) => (
                                        <tr key={i} className="group hover:bg-white/5">
                                            ...
                                            <td className="px-2 py-2"><input type="text" inputMode="decimal" value={d.pct} onChange={e=>updRow(setDividends,i,'pct',e.target.value)} placeholder="%" className="w-16 bg-slate-700 border border-slate-600 rounded px-2 py-1 text-white outline-none focus:border-purple-400 text-xs text-center"/></td>
                                            <td className="px-2 py-2"><input type="text" inputMode="decimal" value={d.amount} onChange={e=>updRow(setDividends,i,'amount',e.target.value)} placeholder="0.00" className="w-28 bg-slate-700 border border-slate-600 rounded px-2 py-1 text-white outline-none focus:border-purple-400 text-xs text-right"/></td>
